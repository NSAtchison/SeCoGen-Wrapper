...
def create_bandit_report(code_filename):
    os.system("bandit " + code_filename + " -f csv -o results.csv")
...
create_bandit_report(python_code_filename)
codes = find_issue_code(bandit_report_filename)
prompts = codes_to_issues(codes)
final_prompt = create_prompt(prompts)
