...
class SecureCodeGen():
    ...
    def generate_python_script(self, output_file: str, gemini_output: str):
        ...
        with open(file_name, "w") as file_to_write:
            file_to_write.write(self.warning_message) # Test
    ...
    def generate(self, prompt):
        ...
        if not pass_1_code:
            print("Error: no code was generated by prompt 1. Retry or modify prompt.")
            return
        ...
        if issues:
            ...
            # shutil.copy(get_file_path(PASS_2_PY_FILE_NAME), get_file_path(FINAL_PY_FILE_NAME))
            # shutil.copy(get_file_path(PASS_2_BANDIT_REPORT_FILE_NAME), get_file_path(FINAL_BANDIT_REPORT_FILE_NAME))
